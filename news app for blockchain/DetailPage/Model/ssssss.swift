...
//        refreshTimer = Timer.scheduledTimer(timeInterval: 60, target: self, selector: #selector(reloadWalletData), userInfo: nil, repeats: true)
//        print(allResult)
//        print(all)
//        refreshData()
//
...
//            let coinSelected = results.filter(filterName)
//
