...
//    var alls = try! Realm().objects(MarketTradingPairs.self)
...
//    var ss:Int = 0
//    
//    //    var kk:Results<MarketTradingPairs>
//    
...
//    
//    func refreshAllData(){
//        let allData = realm.objects(MarketTradingPairs.self)
//        
//        loadCoinPrice(result: allData) { (success,bool) in
//            if bool {
//                DispatchQueue.main.async {
//                    self.profitPrice = 0
...
//                    print("reload")
//                    self.alls = try! Realm().objects(MarketTradingPairs.self)
//                    
//                    self.walletList.reloadData()
...
//    }
//    
//    func loadCoinPrice(result:Results<MarketTradingPairs>,completion:@escaping (Int,Bool)->Void){
...
//        }
//        //        let results = realm.objects(MarketTradingPairs.self)
//        //        try! realm.write {
...
//            let coinSelected = result.filter(filterName)
//            
//            print(String(coinSelected.count)+"reload")
...
//                        var walletData = MarketTradingPairs()
//                        walletData = marketSelectedData
//                        
//                        GetDataResult().getCryptoCurrencyApi(from: walletData.tradingPairsName, to: self.priceType, price: single){success,price in
//                            if success{
//                                DispatchQueue.main.async {
//                                    walletData.singlePrice = price
//                                    walletData.totalPrice = Double(price) * Double(walletData.coinAmount)
//                                    walletData.totalRiseFallPercent = ((walletData.totalPrice - marketSelectedData.transactionPrice) / marketSelectedData.transactionPrice) * 100
//                                    walletData.totalRiseFall = walletData.totalPrice - marketSelectedData.transactionPrice
//                                    if self.ss == 0{
//                                        let results = self.realm.objects(MarketTradingPairs.self)
...
//                                    try! self.realm.commitWrite()
//                                    self.ss = self.ss + 1
//                                    if self.ss == objects.count{
//                                        completion(self.ss,true)
//                                    } else {
//                                        completion(0,false)
//                                    }
//                                }
...
//        var list = [String]()
//        
//        let ee = try! Realm().objects(MarketTradingPairs.self)
//        print("ee")
//        
//        
//        print(ee)
